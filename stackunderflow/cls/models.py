...
from .modules import Embedder, ConvModel
from .modules import unicodeToAscii, preprocess_string

class Model:
	def __init__(self, trained_model_PATH, vocabulary, tag, status = 'raw'):
